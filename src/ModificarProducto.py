...
def crear_frame_modificar_producto(parent, archivo_excel, frame_anterior):
    ...
    boton = tk.Button(subframe_izquierdo, text="Modificar Producto", command=modificar_recargar)
    boton.pack(pady=10)
